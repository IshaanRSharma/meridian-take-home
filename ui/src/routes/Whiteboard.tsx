    ...
    return (
      <div className="space-y-2">
        <div className="rounded-md border border-(--color-accent-dim) bg-(--color-accent-wash) px-3 py-2.5">
          <div className="flex items-center gap-2">
            <MessagesSquare size={14} className="text-[#8fa9ff]" />
            <p className="text-[12.5px] font-medium text-[#8fa9ff]">
    ...
    <div className="space-y-2">
      ...
      {round > 0 && (
        <div className="flex items-center justify-between px-1">
          ...
          <button
            onClick={onSpec}
            className="text-[11.5px] text-[#8fa9ff] transition-colors hover:text-(--color-ink)"
          >
            Freeze the spec →
          </button>
        </div>
